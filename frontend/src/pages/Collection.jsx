...
<<<<<<< HEAD
            ...
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'Personal Care & Hygiene'} onChange={toggleCategory} />Personal Care & Hygiene
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'Clothing & Accessories'} onChange={toggleCategory} />Clothing & Accessories
            </p>
            <p className='flex gap-2'>
